            ...
            <div class="card">
               <div class="card-header">
                  <div class="caption"><i class="fas fa-layer-group font-green"></i>
                     ...
                     <a href="/admin/document/category/" style="text-align: center">Quản lỳ xuất hàng</a> </span>
                  </div>
               </div>
               <div class="col-md">
      ...
      <div class="modal-dialog modal-xl">
         <div class="modal-content">
            ...
            <div class="modal-header">
               <h4 class="modal-title">Chi tiết phiếu xuất</h4>
               ...
               <form id="formxem">
                  <div class="row">
                     <div class="col col-sm-4">
                        <label>Tên đại lý tiêu thụ :</label>
 ...
 <div class="modal" id="Modalthem">
      <div class="modal-dialog modal-xl">
         <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
               <h4 class="modal-title">Tạo phiếu xuất</h4>
               <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <!-- Modal body -->
            <div class="modal-body">
     ...
     function getNguoiDung(){
        ...
        function getNhaCungCap(){
              $.ajax({
                             ...
                             var row = ``;
                                  $.each(res, function (i, v) {
                                   row+=`<option value="`+v.id+`" >`+v.tenDL+`</option>`
...
var status = $(e).attr("status")
 $.ajax({
                             url: '/api/updateStatusXuat/'+id+"/"+status,
                             type:'GET',
                             dataType:'json',
                             contentType: "application/json",
                             success: function (res){
