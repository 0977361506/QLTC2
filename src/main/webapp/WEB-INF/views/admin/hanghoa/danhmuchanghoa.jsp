         ...
         <div class="card">
            <div class="card-header">
               <div class="caption"><i class="fas fa-layer-group font-green"></i>
                  <span class="caption-subject font-green sbold uppercase">Danh mục hàng hóa
                  </span>
               </div>
            </div>
            <div class="card-header">
      ...
      <div class="modal-dialog modal-xs">
         <div class="modal-content">
            ...
            <div class="modal-header">
               <h4 class="modal-title">Thêm danh mục hàng hóa</h4>
...
$(document).ready(function () {
   ...
   function getCategory(id){
        $.ajax({
                       ...
                       var row = ``;
                            $.each(res, function (i, v) {
                              if(v.id==id) row+=`<option value="`+v.id+`" selected>`+v.tenKho+`</option>`
                              else row += `<option value="`+v.id+`">`+v.tenKho+`</option>`
