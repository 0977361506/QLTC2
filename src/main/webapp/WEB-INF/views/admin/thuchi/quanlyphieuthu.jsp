      ...
      <div class="modal-dialog modal-xl">
         <div class="modal-content">
            ...
            <div class="modal-header">
               <h4 class="modal-title">Xem chi tiết phiếu Thu</h4>
...
function them(){
                                            var tennguoinop = $("input[name='tentk1']").val();
                                            var doituong = $("input[name='doituongthu1']").val();
                                            var soTK = $("input[name='sotk1']").val();
                                            var maND = $("#nguoidung").val();
                                            var noiidungThu = $("input[name='noidung1']").val();
                                            var sotien = $("input[name='sotien1']").val();
                                            var ghichu = $("input[name='ghichu1']").val();
                                            var ngaytao =  $("input[name='ngaytao1']").val();
                                            var maPhieuThu =  $("input[name='maphieu1']").val();
                                                  var data = {
